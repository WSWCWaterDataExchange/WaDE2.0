...
namespace WesternStatesWater.WaDE.Managers.Tests
{
    ...
    public class ApiSiteVariableAmountsManagerTests
    {
        ...
        public async Task GetSiteAllocationAmountsAsync_SiteVariableAmount_SiteGeometries(string geometryString, GeometryFormat geometryFormat, string expectedResultString)
        {
