-- Create new WaterAllocationTableType, excluding AllocationAssociatedWithdrawalSiteIDs and AllocationAssociatedConsumptiveUseSiteIDs
...
DROP COLUMN [AllocationAssociatedWithdrawalSiteIDs]
GO

ALTER TABLE [Core].[AllocationAmounts_fact]
DROP COLUMN [AllocationAssociatedConsumptiveUseSiteIDs]
GO