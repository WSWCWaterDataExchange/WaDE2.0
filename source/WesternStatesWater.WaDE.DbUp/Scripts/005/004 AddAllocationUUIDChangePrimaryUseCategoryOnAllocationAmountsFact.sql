...
/****** Blow away this, and allocationBridge tables if Adel says we're dumping the data. Need to write delete table statements for the sql script. If he doesn't, then make it nullable to start, assign values _somehow_, then make non nullable ******/
