...
namespace WaDEImportFunctions
{
    ...
    {
        public ImportRegulatoryReportingUnits(IWaterAllocationManager waterAllocationManager)
        {
        ...
        {
            return await Import.LoadBatch(context, BatchFunctionName, WaterAllocationManager.LoadRegulatoryReportingUnits, log);
        }
        ...
        {
            return await Import.GetCount(context, CountFunctionName, WaterAllocationManager.GetRegulatoryReportingUnitsCount, log);
        }
    }
}
