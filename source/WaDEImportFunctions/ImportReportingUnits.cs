...
namespace WaDEImportFunctions
{
    public class ImportReportingUnits
    {
        ...
        {
            return await Import.LoadBatch(context, BatchFunctionName, WaterAllocationManager.LoadReportingUnits, log);
        }
        ...
        {
            return await Import.GetCount(context, CountFunctionName, WaterAllocationManager.GetReportingUnitsCount, log);
        }
    }
}
