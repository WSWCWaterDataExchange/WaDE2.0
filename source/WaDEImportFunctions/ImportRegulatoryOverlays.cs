...
namespace WaDEImportFunctions
{
    public class ImportRegulatoryOverlays
    {
        ...
        {
            return await Import.LoadBatch(context, BatchFunctionName, WaterAllocationManager.LoadRegulatoryOverlays, log);
        }
        ...
        {
            return await Import.GetCount(context, CountFunctionName, WaterAllocationManager.GetRegulatoryOverlaysCount, log);
        }
    }
}
