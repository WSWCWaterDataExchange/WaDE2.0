...
namespace WaDEImportFunctions
{
    public class ImportPODSiteToPOUSiteRelationships
    {
        ...
        {
            return await Import.LoadBatch(context, BatchFunctionName, WaterAllocationManager.LoadPODSiteToPOUSiteRelationships, log);
        }
        ...
        {
            return await Import.GetCount(context, CountFunctionName, WaterAllocationManager.GetPODSiteToPOUSiteRelationshipsCount, log);
        }
    }
}
