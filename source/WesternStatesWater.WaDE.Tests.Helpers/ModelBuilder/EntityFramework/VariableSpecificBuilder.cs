...
namespace WesternStatesWater.WaDE.Tests.Helpers.ModelBuilder.EntityFramework
{
    public static class VariableSpecificBuilder
    {
        ...
        public static async Task<VariableSpecific> Load(WaDEContext db)
        {
            return await Load(db, new VariableSpecificBuilderOptions());
        }
    ...
    public class VariableSpecificBuilderOptions
    {
    }
}