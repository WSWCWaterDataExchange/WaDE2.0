    ...
    public static class SitesDimBuilder
    {
        ...
        public static SitesDim Create(SitesDimBuilderOptions opts)
        {
            ...
            var faker = new Faker<SitesDim>()
                .RuleFor(a => a.SiteUuid, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.SiteNativeId, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.SiteName, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.UsgssiteId, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.SiteTypeCv, f => f.Random.AlphaNumeric(6))
                ...
                .RuleFor(a => a.CoordinateMethodCv, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.CoordinateAccuracy, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.GniscodeCv, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.EpsgcodeCv, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.NhdnetworkStatusCv, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.NhdproductCv, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.StateCv, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.HUC8, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.HUC12, f => f.Random.AlphaNumeric(6))
                .RuleFor(a => a.County, f => f.Random.AlphaNumeric(6))
                ;
