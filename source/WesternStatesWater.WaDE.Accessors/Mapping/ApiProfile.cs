...
namespace WesternStatesWater.WaDE.Accessors.Mapping
{
    internal class ApiProfile : Profile
    {
        public ApiProfile()
        {
            ...
            CreateMap<EF.AllocationBridgeSitesFact, AccessorApi.Site>()
            ...
            CreateMap<IGrouping<EF.OrganizationsDim, EF.AggregatedAmountsFact>, AccessorApi.AggregatedAmountsOrganization>()
                ...
                .ForMember(a => a.BeneficialUses, b => b.MapFrom(c => c.Select(d => d.PrimaryBeneficialUse).Union(c.SelectMany(d => d.AggBridgeBeneficialUsesFact.Select(e => e.BeneficialUse))).Distinct()))
