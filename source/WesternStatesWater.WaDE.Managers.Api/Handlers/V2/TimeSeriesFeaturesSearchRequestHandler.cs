...
public class TimeSeriesFeaturesSearchRequestHandler(
    AccessorApi.ISiteVariableAmountsAccessor siteVariableAmountsAccessor, 
    IFormattingEngine formattingEngine) : IRequestHandler<TimeSeriesFeaturesSearchRequestBase, TimeSeriesFeaturesSearchResponse>
{
    public async Task<TimeSeriesFeaturesSearchResponse> Handle(TimeSeriesFeaturesSearchRequestBase request)
    {
        ...
        var searchResponse = await siteVariableAmountsAccessor.Search<TimeSeriesSearchRequest, TimeSeriesSearchResponse>(searchRequest);
        ...
        return formatResponse.Map<TimeSeriesFeaturesSearchResponse>();
    }
}